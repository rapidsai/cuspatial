...
cpdef cpp_sw_xy(qx1,qx2,qy1,qy2,in_x,in_y): 
    ...
    with nogil:
        num_hits = sw_xy(c_qx1[0],c_qy1[0],c_qx2[0],c_qy2[0],c_in_x[0],c_in_y[0],c_out_x[0],c_out_y[0])
        
    outx_data, outx_mask = gdf_column_to_column_mem(c_out_x)
    outy_data, outy_mask = gdf_column_to_column_mem(c_out_y)
