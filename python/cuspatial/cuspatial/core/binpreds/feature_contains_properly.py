...
class ContainsProperlyPredicateBase(BinPred, Generic[GeoSeries]):
    ...
    def _compute_predicate(
        ...
        op_result = ContainsProperlyOpResult(result, points, point_indices)
    ...
    def _postprocess(self, lhs, rhs, op_result):
        ...
        preprocessor_output : ContainsProperlyOpResult
            The result of the contains_properly call.
...
class PolygonComplexContainsProperly(ContainsProperlyPredicateBase):
    """Base class for contains operations that use a complex object on
    the right hand side.

    This class is shared by the Polygon*ContainsProperly classes that use
...
DispatchDict = {
    ...
    (Polygon, Point): ContainsProperlyPredicateBase,
    (Polygon, MultiPoint): PolygonComplexContainsProperly,
    (Polygon, LineString): PolygonComplexContainsProperly,
    (Polygon, Polygon): PolygonComplexContainsProperly,
}
