...
cdef extern from "cuspatial/point_linestring_nearest_points.hpp" namespace "cuspatial" nogil:
    ...
    cdef point_linestring_nearest_points_result pairwise_point_linestring_nearest_points(
