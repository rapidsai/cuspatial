...
/**
 * brief Compute Haversine distances between points in set A to the corrosponding points in set B.
 * 
 ...
 */
std::unique_ptr<cudf::column> haversine_distance(cudf::column_view const& a_lon, cudf::column_view const& a_lat,
                                                 cudf::column_view const& b_lon, cudf::column_view const& b_lat,
