...
__global__ void byte_point_in_polygon_kernel(Cart2dItA test_points_first,
...
template <class Cart2dItA,
          ...
          class OffsetIteratorB,
          class OutputIt>
OutputIt byte_point_in_polygon(Cart2dItA test_points_first,
                               ...
                               rmm::cuda_stream_view stream)
{
  ...
  if (num_test_points > 0) {
    ...
    detail::byte_point_in_polygon_kernel<<<num_blocks, threads_per_block, 0, stream.value()>>>(
      test_points_first,
      num_test_points,
