 ...
 * @param[out] output_points_first beginning of output range of (x, y) coordinates within the query
 * window
 ...
 * output_points_first + std::distance(points_first, points_last)), but the ranges may not partially
 * overlap.
