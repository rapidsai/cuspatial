...
struct bbox_transformation {
  __device__ SBBox<T> operator()(const thrust::tuple<T, T> &t) { return SBBox<T>(t, t); }
};
...
struct pairwise_test_intersection {
  ...
  pairwise_test_intersection(uint32_t _M,
                             uint32_t _num_node,
                             const SBBox<double> &_aoi_bbox,
                             double _scale,
                             const uint32_t *_d_p_key,
                             const uint8_t *_d_p_lev,
                             const bool *_d_p_sign,
  ...
  __device__ thrust::tuple<uint8_t, uint8_t, uint32_t, uint32_t> operator()(uint32_t p) const
  {
...
struct twolist_test_intersection {
  ...
  twolist_test_intersection(uint32_t _M,
                            const SBBox<double> &_aoi_bbox,
                            double _scale,
                            const uint32_t *_d_p_key,
                            const uint8_t *_d_p_lev,
