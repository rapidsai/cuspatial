...
struct columnar_point_in_polygon_functor {
  template <typename T>
  ...
  std::pair<std::unique_ptr<cudf::column>, cudf::table_view> operator()(
    ...
    rmm::mr::device_memory_resource* mr)
  {
    ...
    cuspatial::columnar_point_in_polygon(points_begin,
  ...
  rmm::mr::device_memory_resource* mr)
{
  return cudf::type_dispatcher(test_points_x.type(),
                               columnar_point_in_polygon_functor(),
                               test_points_x,
                               test_points_y,
                               poly_offsets,
                               poly_ring_offsets,
  ...
  rmm::mr::device_memory_resource* mr)
{
  ...
  return cuspatial::detail::columnar_point_in_polygon(test_points_x,
                                                      test_points_y,
                                                      poly_offsets,
                                                      poly_ring_offsets,
                                                      poly_points_x,
