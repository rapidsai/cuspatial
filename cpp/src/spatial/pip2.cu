 ...
 * @param[in] ply_y: pointer/array of y coordiantes of concatenated polygons
 
 * @param[out] res_bm: the jth bit of the ith element of the returned GDF_INT32 indicate
 * whether the ith point is in the jth polygon.
 
 * Note: The # of polygons, i.e., ply_size can not exceed sizof(uint), i.e., 32.
 */
 ...
 * @param[in] ply_fpos: pointer/array to index polygons, i.e., prefix-sum of #of rings of all polygons
 * @param[in] ply_rpos: pointer/array to index rings, i.e., prefix-sum of #of vertices of all rings
 * @param[in] ply_x: pointer/array of x coordiante of points
 * @param[in] ply_y:
 *
 * @returns gdf_column of type GDF_INT32; the jth bit of the ith element of the returned GDF_INT32 indicate
 whether the ith point is in the jth polygon.
 Note: The # of polygons, i.e., ply_fpos.size can not exceed sizof(uint), i.e., 32.
 */
