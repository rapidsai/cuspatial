...
struct byte_point_in_polygon_functor {
  template <typename T>
                                           ...
                                           rmm::mr::device_memory_resource* mr)
  {
    ...
    cuspatial::byte_point_in_polygon(points_begin,
...
std::unique_ptr<cudf::column> byte_point_in_polygon(cudf::column_view const& test_points_x,
                                                    cudf::column_view const& test_points_y,
                                                    cudf::column_view const& poly_offsets,
                                                    cudf::column_view const& poly_ring_offsets,
                                                    cudf::column_view const& poly_points_x,
                                                    ...
                                                    rmm::mr::device_memory_resource* mr)
{
  ...
  return cuspatial::detail::byte_point_in_polygon(test_points_x,
                                                  test_points_y,
                                                  poly_offsets,
                                                  poly_ring_offsets,
                                                  poly_points_x,
