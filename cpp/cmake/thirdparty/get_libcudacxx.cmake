...
function(find_and_configure_libcudacxx)
  ...
  rapids_cpm_libcudacxx(BUILD_EXPORT_SET cuspatial-exports INSTALL_EXPORT_SET cuspatial-exports)
  ...
  if(libcudacxx_SOURCE_DIR)
    ...
    rapids_export_find_package_root(
      INSTALL
      libcudacxx
      [=[${CMAKE_CURRENT_LIST_DIR}/../../../include/libcuspatial/lib/rapids/cmake/libcudacxx]=]
      cuspatial-exports
    )
  endif()
endfunction()
