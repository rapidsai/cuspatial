...
TEST_F(TrajectoryDeriveToy, trajectoryderivetest)
{
  ...
  std::cout << "x:" << std::endl;
  std::copy(point_x_vec.begin(), point_x_vec.end(), std::ostream_iterator<double>(std::cout, " "));
  std::cout << std::endl;
  std::cout << "y:" << std::endl;
  std::copy(point_y_vec.begin(), point_y_vec.end(), std::ostream_iterator<double>(std::cout, " "));
  std::cout << std::endl;
  ...
  std::cout << "points within query window(" << x1.data.fp64 << "," << y1.data.fp64 << ","
            << x2.data.fp64 << "," << y2.data.fp64 << ")" << std::endl;
  ...
  std::cout << "x:" << std::endl;
  thrust::copy(out_x_ptr, out_x_ptr + num_print, std::ostream_iterator<double>(std::cout, " "));
  std::cout << std::endl;
  std::cout << "y:" << std::endl;
  thrust::copy(out_y_ptr, out_y_ptr + num_print, std::ostream_iterator<double>(std::cout, " "));
  std::cout << std::endl;
}
