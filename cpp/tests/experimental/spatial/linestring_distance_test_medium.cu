...
TYPED_TEST(PairwiseLinestringDistanceTestMedium, RandomDataset100)
{
  ...
  // ../../../../ tests / utility /
  //   vector_equality.hpp : 98 : Failure Value of
  //   : to_host<T>(lhs)
  // Expected: contains 100 values, where each value and its corresponding value in { 22000.9,
  // 66907.6, 91320, 85968.2, 102672, 65694.8, 23155.6, 69965.8, 74404.8, 50402, 86674.1,
  // 78620.6, 50270.7, 21742.8, 57053.3, 59274.3, 48859.4, 81538.7, 102451, 48907.8, 2541.18,
  // 54018.7, 80019.8, 99125.2, 86909.8, 100367, 68313.3, 97214.4, 60565, 79060.8, 120582,
  // 42683.4, ... } are approximately equal floats
  //   Actual: { 22000.9, 66907.6, 91320, 85968.2, 102672, 65694.8, 23155.6, 69965.8, 74404.8,
  //   50402, 86674.1, 78620.6, 50270.7, 21742.8, 57053.3, 59274.3, 48859.4, 81538.7, 102451,
  //   48907.8, 2541.18, 54018.7, 80019.8, 99125.2, 86909.8, 100367, 68313.3, 97214.4, 60565,
  //   79060.8, 120582, 42683.4, ... }, where the value pair (2541.18, 2541.18) at index #20
  //   don't match, 2541.176513671875 != 2541.178466796875
