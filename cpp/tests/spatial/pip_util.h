 ...
 *        basic unit for either sequential execution or parallellization in
 * multi-point/multi-polygon test cases
 *
...
template bool pip_test_sequential(const double& x,
                                  const double& y,
                                  const struct polygons<double>& ply,
                                  int fid);
template bool pip_test_sequential(const float& x,
                                  const float& y,
                                  const struct polygons<float>& ply,
                                  int fid);
 ...
 */
template <typename T>
std::vector<uint32_t> cpu_pip_loop(int num_pnt,
                                   const T* x,
                                   const T* y,
...
template std::vector<uint32_t> cpu_pip_loop(int num_pnt,
                                            const double* x,
                                            const double* y,
