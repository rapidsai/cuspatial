...
TEST_F(TrajectoryDeriveToy, trajectoryderivetest)
{
  ...
  cuspatial::trajectory_spatial_bounds(
  	*(point_x_wrapp.get()),*(point_y_wrapp.get()),*(traj_len_wrapp.get()),*(traj_pos_wrapp.get()),
  	x1,y1,x2,y2);
  ...
  thrust::copy(x1_ptr,x1_ptr+num_print,std::ostream_iterator<double>(std::cout, " "));std::cout<<std::endl; 
  std::cout<<"y1:"<<std::endl;
  thrust::copy(y1_ptr,y1_ptr+num_print,std::ostream_iterator<double>(std::cout, " "));std::cout<<std::endl; 
  std::cout<<"x2:"<<std::endl;
  thrust::copy(x2_ptr,x2_ptr+num_print,std::ostream_iterator<double>(std::cout, " "));std::cout<<std::endl; 
  std::cout<<"x2:"<<std::endl;
  thrust::copy(y2_ptr,y2_ptr+num_print,std::ostream_iterator<double>(std::cout, " "));std::cout<<std::endl; 
