...
TEST_F(TrajectorySubsetToy, trajectorysubsettest)
{
    ...
    std::copy(rand_ts.begin(),rand_ts.end(),std::ostream_iterator<cuspatial::its_timestamp>(std::cout, " "));std::cout<<std::endl;
    ...
    *(point_x_wrapp.get()), *(point_y_wrapp.get()),*(point_id_wrapp.get()),*(point_ts_wrapp.get()),
    ...
    thrust::device_ptr<cuspatial::its_timestamp> out_ts_ptr=thrust::device_pointer_cast(static_cast<cuspatial::its_timestamp*>(out_ts.data));
    ...
    thrust::copy(out_ts_ptr,out_ts_ptr+num_print,std::ostream_iterator<cuspatial::its_timestamp>(std::cout, " "));std::cout<<std::endl;
}
