...
function(find_and_configure_cudf VERSION)
    ...
    rapids_cpm_find(
      ...
      BUILD_EXPORT_SET cugeo-exports
      INSTALL_EXPORT_SET cugeo-exports
      CPM_ARGS
...
set(CUGEO_MIN_VERSION_cudf "${CUGEO_VERSION_MAJOR}.${CUGEO_VERSION_MINOR}.00")

find_and_configure_cudf(${CUGEO_MIN_VERSION_cudf})
